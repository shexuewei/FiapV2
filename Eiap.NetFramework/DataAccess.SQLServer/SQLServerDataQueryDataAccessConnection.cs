...
{
    public class SQLServerDataQueryDataAccessConnection : ISQLDataQueryDataAccessConnection
    {
        ...
        public SQLServerDataQueryDataAccessConnection(ISQLDataAccessConnectionString SQLDataAccessConnectionString)
        {
            _SQLDataAccessConnectionString = SQLDataAccessConnectionString;
            _ConnectionString = _SQLDataAccessConnectionString.DataQueryConnectionString();
        }
